...
class GELUActivation(nn.Cell):
    ...
    ms.ops.tanh(math.sqrt(2 / math.pi) * (x + 0.044715 * ms.ops.pow(x, 3)))) This is now written in C in nn.functional
...
class ClippedGELUActivation(nn.Cell):
    ...
    ms.ops.tanh(math.sqrt(2 / math.pi) * (x + 0.044715 * ms.ops.pow(x, 3)))). See https://arxiv.org/abs/1606.08415
    """
...
class LeakyReLU(nn.LeakyReLU):
    def __init__(self, negative_slope=1e-2):
        super(LeakyReLU, self).__init__(alpha=negative_slope)
